...
- (BOOL)shouldSelectAsset:(ELCAsset *)asset previousCount:(NSUInteger)previousCount
{
    ...
    if (!shouldSelect) {
        NSString *title = [NSString stringWithFormat:@"%d%@", self.maximumImagesCount,NSLocalizedString(@"LIMIT", nil)];
        NSString *message = [NSString stringWithFormat:@"%@、%d%@",NSLocalizedString(@"AT_TIME",nil), self.maximumImagesCount,NSLocalizedString(@"LIMIT_PICK", nil)];
