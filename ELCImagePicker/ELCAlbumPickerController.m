        ...
        // Group enumerator Block
            ...
            void (^assetGroupEnumberatorFailure)(NSError *) = ^(NSError *error) {
                ...
                if ([ALAssetsLibrary authorizationStatus] == ALAuthorizationStatusDenied) {
                    NSString *errorMessage = NSLocalizedString(@"NO_ACCESS_REASON", nil);
                    [[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"NO_ACCESS", nil) message:errorMessage delegate:nil cancelButtonTitle:NSLocalizedString(@"YES", nil) otherButtonTitles:nil] show];
                  
                } else {
                    NSString *errorMessage = [NSString stringWithFormat:@"アルバムエラー： %@ - %@", [error localizedDescription], [error localizedRecoverySuggestion]];
                    [[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"ERROR", nil) message:errorMessage delegate:nil cancelButtonTitle:NSLocalizedString(@"YES", nil) otherButtonTitles:nil] show];
                }
...
{
	[self.tableView reloadData];
	[self.navigationItem setTitle:NSLocalizedString(@"CHOOSE_ALBUM", nil)];
}
